...
/**
 * Test class for {@link KeyServiceImplNoDB}.
 * 
 * @author amohan
 */
@RunWith(SpringRunner.class)
@TestPropertySource(locations = "classpath:application-test.properties")
public final class KeyServiceImplNoDBTest {
    ...
    /**
     * Test class for {@link KeyServiceImplNoDB#getFileKey(String)}. Verify the
     * EncryptionKey.
     */
    @Test
    public void testGetFileKey() {
        when(myCipherConfig.getFileKey(ID)).thenReturn(FILE_KEY);
        assertThat(keyService.getFileKey(ID), equalTo(FILE_KEY));
    }

    /**
     * Test class for {@link KeyServiceImplNoDB#getPrivateKey(String)}. Verify the
     * PrivateKey.
     */
    @Test
    ...
    /**
     * Test class for {@link KeyServiceImplNoDB#getPrivateKeyString(String)}. Verify the
     * PrivateKeyString.
     */
    @Test
    ...
    /**
     * Test class for {@link KeyServiceImplNoDB#getPublicKey(String, String)}. Verify
     * the PublicKey.
     */
    @Test
    ...
    /**
     * Test class for {@link KeyServiceImplNoDB#getPublicKeyFromPrivate(String)}. Verify
     * the pgpPublicKey.
     */
    @Test
    ...
    /**
     * Test class for {@link KeyServiceImplNoDB#getKeyIDs(String)}. Verify the keyIds.
     */
    @Test
